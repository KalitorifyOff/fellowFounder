...
class _ReferralsScreenState extends State<ReferralsScreen> {
  ...
  Widget build(final BuildContext context) => Scaffold(
    ...
    children: [
      ...
      //* Image
      const AppImage(imageUrl: Assets.referral1, height: 250, width: 250),
  ...
  children: [
    ...
    Container(
      ...
      child: Row(
        ...
        children: [
          Text(
              'https://www.fellowfounder.in/', style: AppText.b3!.cl(const Color(0xFF002381))
          ),
          InkWell(
              onTap: () async {
                await Clipboard.setData(const ClipboardData(text: 'https://www.fellowfounder.in/'));
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text(S.linkCopied)),
                );
              },
              child: Text('Copy', style: AppText.b3b!.cl(const Color(0xFF002381)),))
        ],
      ),
    ),
    ...
    PrimaryButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (final context) => const InvitePeopleScreen()),
          );
        },
        text: S.invitePeople,
        ...
        child: Row(
          ...
          children: [
            const AppImage(imageUrl: 'assets/icons/users.png', height: 20, width: 20),
